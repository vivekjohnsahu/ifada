...
var app = angular.module("myApp", ['ngRoute','rzSlider', 'ui.bootstrap','slickCarousel', 'ngSanitize', 'ngCookies','ngSidebarJS', 'geolocation', 'ngCordovaOauth', 'ngCordova','pascalprecht.translate']);
