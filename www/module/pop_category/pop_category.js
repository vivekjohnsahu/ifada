app.controller('pop_category', function ($filter, $scope, $http, $location, $interval, $cookieStore, model, $locale, loading, $rootScope) {
...
$rootScope.selecthome();
    ...
    $scope.category_data = function () {
        ...
        loading.active();
		 ...
		 if($cookieStore.get("pop_category_data")){
			var cat_id = '';
       ...
       //   console.log(res.data.data);
           if(res.data.data.status == 'success'){
            $scope.category_data = res.data.data.popular_category_list;
